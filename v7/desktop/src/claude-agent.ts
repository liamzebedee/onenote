...
import type { ClaudeStreamData } from '../../core/src/types';
...
class ClaudeAgent {
  ...
  constructor(cwd: string, context: string, mcpConfigPath?: string | null) {
    this.cwd = cwd;
  ...
  sendMessage(text: string, onData: (data: ClaudeStreamData) => void): void {
