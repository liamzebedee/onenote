...
export function handleMarkdownInput(el) {
...
export function handleInlineCode(el) {
  const info = getSelectionInfo();
...
export function onBlockKeyDown(e, el) {
